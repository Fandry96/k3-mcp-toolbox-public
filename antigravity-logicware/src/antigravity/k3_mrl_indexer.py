        ...
        try:
            ...
            if self._matrix_cache is None or self._paths_cache is None or self._matrix_short_norm_cache is None:
                ...
                if self.index:
                    ...
                    # ⚡ BOLT OPTIMIZATION: Use np.einsum for faster 1D squared norms instead of np.linalg.norm
            ...
            # Normalize Query
            # ⚡ BOLT OPTIMIZATION: Use np.dot for faster vector norm instead of np.linalg.norm
            ...
            # ⚡ BOLT OPTIMIZATION: Use np.einsum/np.dot for faster 1D squared norms instead of np.linalg.norm
