...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION: Avoid allocating intermediate normalized matrix for candidates.
            # Compute 1D squared norms and raw dot product, then scale (4x+ faster than full norm).
