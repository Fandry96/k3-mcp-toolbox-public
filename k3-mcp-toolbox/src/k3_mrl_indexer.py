...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION:
            # Use np.einsum for 1D squared norms instead of np.linalg.norm to avoid large
            # NxD normalized matrix allocation. Computes raw dot product and scales.
            ...
            # ⚡ BOLT OPTIMIZATION:
            # Avoid NxD normalized matrix allocation for STAGE 2 reranking.
