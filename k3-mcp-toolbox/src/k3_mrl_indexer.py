...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # Compute raw dot product and scale by 1D norms.
            ...
            scores_short = raw_scores_short / (m_short_norms * q_short_norm_scalar + 1e-9)
            ...
            q_full_norm_scalar = np.linalg.norm(q_vec)
            scores_full = raw_scores_full / (m_full_norms * q_full_norm_scalar + 1e-9)
