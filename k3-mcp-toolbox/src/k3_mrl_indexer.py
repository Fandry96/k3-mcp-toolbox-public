...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION: Use raw dot product scaled by 1D squared norms via einsum
            # Avoids O(N x D) normalized matrix allocation, improving low-res shortlist speed
