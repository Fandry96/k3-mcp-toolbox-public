...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION: Avoid allocating intermediate normalized Nx768 matrices.
            # Calculate dot product first, then scale by 1D norms.
            # Use einsum for squared norms to avoid linalg.norm overhead.
            ...
            scores_full = raw_scores / (np.sqrt(m_full_sq_norms * q_full_sq_norm) + 1e-9)
