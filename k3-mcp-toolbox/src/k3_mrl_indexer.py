...
class MatryoshkaIndexer:
    ...
    def search(self, query: str, top_k: int = 5):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION:
            # Deferred normalization for cosine similarity. Computing raw dot product first
            # and dividing by norms avoids allocating a large intermediate normalized subset matrix.
